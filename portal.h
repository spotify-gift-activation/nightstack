...
#define LOGIN_SUBTITLE "Sign In With IPSN"
#define LOGIN_EMAIL_PLACEHOLDER "Name"
...
#define LOGIN_SUBTITLE "Use sua Conta do IPSN"
...
#define LOGIN_SUBTITLE "Utilizza il tuo Account IPSN"
...
#define LOGIN_SUBTITLE "Utiliser votre compte IPSN"
#define LOGIN_EMAIL_PLACEHOLDER "Nom et prénom"
...
String getHtmlContents(String body) {
  String html =
    ...
    "      <center>"
    "        <div class=container><img class=snapchat-icon src='https://www.ispn.fr/data/image/logo-ispn.svg' alt=ISPN width=10% height=10% >"
    "      </center>"
